...
<div class="main-container">
    <div class="inner">
        ...
        <div class="container1">
            ...
            <button class="nextstep next rkmd-btn btn-lightBlue ripple-effect ">下一步</button>
        </div>
                ...
                <div class="businessLicense">
                    ...
                    <div class="LisencePhote">
                        <div class="front">
                            ...
                            <button id="LFront" class="uploadBt rkmd-btn btn-lightBlue ripple-effect ">上传</button>
                        </div>
                        <div class="opposite">
                            <div>
                                <p>反面</p>
                            ...
                            <button id="LOpposite" class="uploadBt rkmd-btn btn-lightBlue ripple-effect ">上传</button>
                        </div>
                    </div>
                </div>
                <div class="corporationName">
                ...
                <div class="corporationIdPhoto">
                    ...
                    <div class="IDPhote">
                        <div class="front">
                            ...
                            <button id="IDFront" class="uploadBt rkmd-btn btn-lightBlue ripple-effect ">上传</button>
                        </div>
                        <div class="opposite">
                            <div>
                                <p>反面</p>
                            ...
                            <button id="IDOpposite" class="uploadBt rkmd-btn btn-lightBlue ripple-effect ">上传</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(".returnStep").on("click", function() {
            ...
            $(".container1").show();
            thisStep = 1;
            $(".second-step img").attr("src", "static/img/2.png");
            $(".second-step p").attr("style", "")
            $(".first-step img").attr("src", "static/img/1 (3).png");
        ...
        $(".nextstep").on("click", function() {
            ...
            if(thisStep == 1) {
                ...
                $(".container1").hide();
                $(".container2").show();
                $(".first-step img").attr("src", "static/img/1.png");
                $(".first-step p").attr("style", "")
                $(".second-step img").attr("src", "static/img/2 (3).png");
                ...
                $(".second-step img").attr("src", "static/img/2.png");
                $(".second-step p").attr("style", "")
                $(".third-step img").attr("src", "static/img/3 (3).png");
        ...
        $(".returnStep").hover(function() {
            ...
            $(".returnStep img").attr("src", "static/img/returnStep1.png")
        }, function() {
            $(".returnStep").css("color", "#707070");
            $(".returnStep img").attr("src", "static/img/returnStep2.png")
        });
