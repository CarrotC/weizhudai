    ...
    <div>
        <ul class="nav navbar-nav">
            <li class="li-item active">
                <a href="login.html">
                    <P class="main-style">登录/注册</P>
                </a>
            </li>
            <li class="li-item">
                <a href="/frontend/center/aboutUs">
                    <P class="main-style">关于我们</P>
                </a>
            </li>
            <li class="li-item">
                <a href="/frontend/center/contactUs">
...
<div class="main-container">
    ...
    <p class="lineTitle">微&nbsp;助&nbsp;贷</p>
    <p class="prompt">————基于区块链技术的小微企业贷款风险评估系统</p>
    <div class="container">
        <div class="bank-box before">
            <div class="inner">
                <div class="before-cg">
                    <p>切换企业入口</p>
                ...
                <div class="btBox">
                    <button onclick="bankLogin()" id="submit-bank" style="width: 100%;"
                            class="submit rkmd-btn btn-lightBlue ripple-effect"><p style="margin: 0;font-size: 16px;">登录</p>
                    </button>
                </div>
            </div>
        </div>
        <div class="company-box after">
            <div class="inner" style="display: none;">
                ...
                <div class="btBox">
                    <button onclick="companyLogin()" id="submit-company"
                            class="submit rkmd-btn btn-lightBlue ripple-effect"><p style="margin: 0;font-size: 16px;">登录</p>
                    </button>
                    <button id="register" class="register rkmd-btn btn-lightBlue ripple-effect"
                            onclick="turnToSignIn()"><p style="margin: 0;font-size: 16px;">前往注册</p>
                    </button>
                </div>
            </div>
