...
import org.seckill.dao.CompanyInfoMapper;
...
public class CompanyServiceImpl implements CompanyService {
    ...
    public Company getCompanyByName(String name){
        return this.companyInfoMapper.selectCompanyByName(name);
    }
...
//        return this.companyInfoMapper.selectCompanyByFuzzyName(input);
//    }
}
